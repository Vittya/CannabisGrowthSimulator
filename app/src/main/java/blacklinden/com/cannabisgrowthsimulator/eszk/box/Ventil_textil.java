...
public class Ventil_textil extends RelativeLayout {
    ...
    public Ventil_textil(Context context) {
        super(context);
        innit(context);
    }

    public Ventil_textil(Context context, AttributeSet attrs) {
        super(context, attrs);
        innit(context);
    }

    public Ventil_textil(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void innit(Context context){
        ...
        inflater.inflate(R.layout.ventil_view_textil, this);
